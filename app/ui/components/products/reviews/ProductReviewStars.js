  ...
  render() {
    return (
      <div className="rating-stars">
        ...
        <polygon points="26.934,1.318 35.256,18.182 53.867,20.887 40.4,34.013 43.579,52.549 26.934,43.798 
          10.288,52.549 13.467,34.013 0,20.887 18.611,18.182 "/>
        </svg> <span className="text">{this.props.rating}</span><span className="ar-icon arrow-right"></span><a href="#" className="text link">143 Reviews</a> <span className="ar-icon arrow-right"></span><a href="#" className="text">Write a Review</a>
      </div>
    );
  }
}
